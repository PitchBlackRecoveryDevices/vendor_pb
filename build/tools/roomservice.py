...
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'android-11.0')
custom_dependencies = "omni.dependencies"
org_manifest = "PitchBlackRecoveryProject"  # leave empty if org is provided in manifest
org_display = "PitchBlackRecoveryProject"  # needed for displaying
